// src/app/privacy/page.tsx — KOVA Privacy Policy
      ...
      <div className="max-w-2xl mx-auto px-5 py-10">
        ...
        <div className="space-y-6 text-sm leading-relaxed" style={{ color: 'var(--text-secondary)' }}>
          <section>
            ...
            <p>
              KOVA is operated by DBEK, a company registered in France at 75 rue de Lourmel, 75015 Paris, France.
              KOVA provides a community-powered safety mapping and navigation platform (&ldquo;the Service&rdquo;).
          ...
          <section>
            ...
            <ul className="list-disc ml-5 space-y-1">
              ...
              <li><strong>Payment data:</strong> If you subscribe to KOVA Pro, payments are processed by Stripe. We store your Stripe customer ID and subscription status, but never your card details.</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p>
              KOVA is not directed to children under 16. We do not knowingly collect data from children.
