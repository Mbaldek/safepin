        ...
        {step === 'input' && (
          <>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12, marginBottom: 24 }}>
              ...
              <button disabled style={{ ...btnOAuth, opacity: 0.4, cursor: 'not-allowed' }}>
                ...
                <span style={{ display: 'flex', flexDirection: 'column', lineHeight: 1.2 }}>Apple <span style={{ fontSize: 9, opacity: 0.7 }}>Bient&ocirc;t disponible</span></span>
              </button>
            </div>
