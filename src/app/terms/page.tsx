// src/app/terms/page.tsx — KOVA Terms of Service
      ...
      <div className="max-w-2xl mx-auto px-5 py-10">
        ...
        <div className="space-y-6 text-sm leading-relaxed" style={{ color: 'var(--text-secondary)' }}>
          <section>
            ...
            <p>
              By accessing or using KOVA (&ldquo;the Service&rdquo;), you agree to these Terms of Service.
          ...
          <section>
            ...
            <p>
              KOVA is a community-powered safety mapping platform that allows users to report safety incidents,
              navigate with safety-aware routing, trigger emergency alerts, and communicate with their community.
              KOVA does <strong>not</strong> replace emergency services. In case of immediate danger, always call
          ...
          <section>
            ...
            <ul className="list-disc ml-5 space-y-1">
              ...
              <li>By posting, you grant KOVA a worldwide, royalty-free licence to display, distribute, and process your content as part of the Service.</li>
              <li>KOVA may remove content that violates these Terms or community guidelines.</li>
              <li>Reports may be anonymised and used in aggregate to improve community safety.</li>
            </ul>
          </section>

          <section>
            <h2 className="text-base font-black mb-2">6. KOVA Pro Subscription</h2>
            <ul className="list-disc ml-5 space-y-1">
              <li>KOVA Pro is available as a monthly or annual subscription.</li>
          ...
          <section>
            ...
            <p>
              KOVA provides tools to alert your contacts and share your location in emergencies.
              However, <strong>KOVA is not an emergency service</strong>. We do not guarantee response
          ...
          <section>
            ...
            <p>
              ...
              a real person but does not imply endorsement or background checking. KOVA is not responsible
          ...
          <section>
            ...
            <p>
              To the maximum extent permitted by law, KOVA and DBEK are not liable for: (a) the accuracy
          ...
          <section>
            ...
            <p>
              The KOVA name, logo, design, and software are the property of DBEK. You may not copy,
