// src/app/cookies/page.tsx — Breveil Cookie Policy
        ...
        <div className="space-y-6 text-sm leading-relaxed" style={{ color: 'var(--text-secondary)' }}>
          <section>
            ...
            <p>
              ...
              Breveil uses minimal cookies — only what is strictly necessary to operate the Service.
            </p>
          </section>
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-xs mt-2" style={{ borderCollapse: 'collapse' }}>
                ...
                <tbody style={{ color: 'var(--text-muted)' }}>
                  ...
                  <tr style={{ borderBottom: '1px solid var(--border)' }}>
                    <td className="py-2 pr-3 font-mono">breveil_theme</td>
          ...
          <section>
            ...
            <p className="mb-2">
              In addition to cookies, Breveil uses browser local storage for app functionality:
            </p>
            <ul className="list-disc ml-5 space-y-1">
              <li><strong>breveil_active_trip:</strong> Persists active trip navigation state.</li>
              <li><strong>breveil_last_session_ts:</strong> Tracks when you last visited (for session briefing).</li>
              <li><strong>breveil_notifications_enabled:</strong> Push notification preference.</li>
          ...
          <section>
            ...
            <p>
              Breveil does <strong>not</strong> use any third-party tracking, analytics, or advertising cookies.
          ...
          <section>
            ...
            <p>
              Since Breveil only uses essential and functional cookies, we do not display a cookie consent banner.
