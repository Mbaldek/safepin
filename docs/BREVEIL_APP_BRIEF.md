...
│   ├── onboarding/         # 5-step onboarding funnel
│   │   ├── welcome/
│   │   ├── profile/        # Name, DOB, city, persona
│   │   ├── goals/          # Feature goals selection
│   │   ├── permissions/    # Location + notifications
│   │   └── circle/         # Add trusted contacts
...
### 7.1 Live Safety Map
- Mapbox GL — dark/light/streets style switch
...
| `trip` | safetyEscort, planRoute, dangerScore, startTrip, endTrip, savedRoutes, walkWithMe |
...
| `onboarding` | welcome, persona options, goal options, permissions |
...
*End of brief — ~600 lines. For deeper context on any feature, ask for the relevant source file.*
